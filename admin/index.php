...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="../index.php" class="logo">MY <span class="lite">Blog</span></a>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="img/sa.png" height=50px>
                            </span>
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li class="eborder-top">
                <a href="../admin/profile.php"><i class="icon_profile"></i> My Account</a>
              </li>
              <li>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" method="post" action="../include/addmenu.php">
...
<tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="../include/removemenu.php?id=<?=$menu['id']?>">Remove <i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
            <?php
...
<tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="../include/removesubmenu.php?id=<?=$menu['id']?>">Remove <i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
            <?php
